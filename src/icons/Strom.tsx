type StromIconProps = {
  ...
  export const StromIcon: React.FC<StromIconProps> = ({
    ...
    <svg
    width={size}
    height={size} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64">
	<defs>
		...
		<linearGradient id="h" x1="26.74" y1="37.88" x2="35.76" y2="53.52" gradientUnits="userSpaceOnUse">
	...
	<polygon points="30 36 26 48 30 48 28 58 38 44 32 44 36 36 30 36" stroke="#f6a823" stroke-miterlimit="10" stroke-width="0.5" fill="url(#h)">
